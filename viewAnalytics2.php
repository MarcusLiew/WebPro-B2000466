            ...
            <div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody class="bg-light">
                        <?php
                        $getNumOfSchWorkLocssql = "SELECT workDate, workLocation, COUNT(*) as numOfSchedules FROM dailyscheduledb WHERE workDate BETWEEN '$startDate' 
                        AND '$endDate' AND EmployeeID IN (SELECT employeeID FROM employeedb WHERE deptID = '$deptID') GROUP BY workDate, workLocation;";
                ...
                <table class="table table-bordered">
                    ...
                    <tbody class="bg-light">
                        <?php
                        $getNumOfSchWorkHourssql = "SELECT workDate, workHours, COUNT(*) as numOfSchedules FROM dailyscheduledb WHERE workDate BETWEEN '$startDate' 
                        AND '$endDate' AND EmployeeID IN (SELECT employeeID FROM employeedb WHERE deptID = '$deptID') GROUP BY workDate, workLocation;";
